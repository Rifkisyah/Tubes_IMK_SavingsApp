...
<body class="auth-page-body">
    <div class="auth-card">
        ...
        <hr>
        <h2>Masuk</h2>
        <form action="submit_masuk.php" method="post" id="auth-form">
            ...
            <button type="submit" href="Halaman_Beranda.php">Masuk</button>
            <a href="Halaman_Daftar.php">Belum punya akun? Daftar di sini</a> 
        </form>
    </div>
